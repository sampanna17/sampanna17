...
I am a 20-year-old IT student with a passion for **software engineering** and **web development**. I am continuously learning and expanding my skill set in both frontend and backend development, with experience in technologies like **React**, **Node.js**, and **Express.js**. My goal is to build innovative, user-centric applications that solve real-world problems. As I grow in my journey, I am keen on honing my expertise in full-stack development and contributing to open-source projects.
